...
const Nav = () => {
  return (
    <nav className='appNav lg:px-16 px-6 flex flex-wrap items-center lg:py-0 py-2 -mb-18 z-20 relative'>
      <div className="flex-1 flex justify-between items-center">
        <a href="#" className="logo"></a>
      </div>
      <div className="hidden lg:flex lg:items-center lg:w-auto w-full" id="menu">
        <div>
          <ul className="lg:flex items-center justify-between text-base text-white font-montserrat font-medium pt-4 lg:pt-0">
